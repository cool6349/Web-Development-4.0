...
let myDate = new Date();
console.log(myDate); // 2024-05-21T09:44:24.349Z
console.log(myDate.toDateString());  // Tue May 21 2024
console.log(myDate.toLocaleString()); // 21/5/2024, 3:16:21 pm
console.log(myDate.toLocaleDateString()); // 21/5/2024
console.log(myDate.toTimeString()); // 15:17:58 GMT+0530 (India Standard Time)
